    ...
    <div class="container-fluid">
        <div class="col-lg-5 mb-5">
            ...
            <form method="POST">
                ...
                <div class="control-group">
                    <input type="text" class="form-control" id="subject" name="password" placeholder="Password" required="required" data-validation-required-message="Please enter a subject" />
                    <p class="help-block text-danger"></p>
                </div>
                <div class="Lo">

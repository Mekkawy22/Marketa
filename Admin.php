...
<body>
    ...
    <div class="container-fluid">
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
           <div class="logo">
                <a href="index.php"><img src="img/MarketaLOGO.png" alt=""/></a>			 
           </div>
            
            <
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Alfa</span>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/Al Doha Egyptian Flour-1kg.jpg" alt="">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="">Al Doha Egyptian Flour-1kg</a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>20.90</h5><h6 class="text-muted ml-2"><del>22LE</del></h6>
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/Regina Elbow Pasta - 400 grams.jpg" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="cart.php"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="">Regina Elbow Pasta - 400 grams/a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>11LE</h5><h6 class="text-muted ml-2"><del>12LE</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <small class="fa fa-star text-primary mr-1"></small>
                            <small class="fa fa-star text-primary mr-1"></small>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>Mekkmekkawy@gmail.com</p>
